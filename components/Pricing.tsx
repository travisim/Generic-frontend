      ...
      <Container>
        ...
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          ...
          <Plan
            name="Enterprise"
            price="Contact us"
            description="If you would like to make your hiring process more accessible to students"
            href="/register"
            features={[
              "Our students come from top universities in Singapore",
              "Reach out to students who might have missed out on your job posting",
            ]}
          />
        </div>
        <p className="mt-4 text-sm text-gray-500">
          * The free pricing is for a limited time. Services are free as your data would be used to train our AI.
        </p>
